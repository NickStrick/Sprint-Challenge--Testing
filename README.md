...
describe are headers when displaying tests. it/test are tests that are being run and checked. using nested describe methods will organize your tests.

1. What is the point of `Test Driven Development`? What do you think about this approach?

test driven development, is development where tests are created first, to make sure the api/client works exactly how you want it too.
i think its very strong model to follow because it tramendously reduces holes in a program.

1. Mention three types of automated tests.

unit testing, integrated testing, end to end.
